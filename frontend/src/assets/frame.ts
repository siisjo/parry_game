...
export const frames = {
  parry: {
    pre: {
      LEFT: [parryL1, parryL2, parryL3, parryL4, parryL5],
      RIGHT: [parryR1, parryR2, parryR3, parryR4, parryR5]
    },
    success: [parrySuccess1, parrySuccess2, parrySuccess3, parrySuccess4, parrySuccess5],
    fail: [parryFail]
  },
  chainParry: {
    pre: {
      LEFT: [chainL1, chainL2, chainL3, chainL4, chainL5],
      RIGHT: [chainR1, chainR2, chainR3, chainR4, chainR5]
    },
    success: [parrySuccess1, parrySuccess2, parrySuccess3, parrySuccess4, parrySuccess5]
  },
  fakeParry: {
